...
export function HomeHero({ anime }: HomeHeroProps) {
  ...
  return (
    <section className="relative overflow-hidden rounded-[var(--radius-xl)] border border-[var(--line)] bg-[var(--surface-strong)] shadow-[0_32px_90px_var(--shadow-strong)]">
      ...
      <div className="relative grid gap-5 p-4 sm:gap-6 sm:p-8 lg:grid-cols-[minmax(0,1fr)_22rem] lg:p-10">
        ...
        <Link to={`/anime/${anime.source}/${anime.externalId}`} className="group relative min-h-72 overflow-hidden rounded-[var(--radius-xl)] border border-[var(--line)] bg-[var(--surface-inset)] outline-none focus:ring-4 focus:ring-[var(--focus)] sm:min-h-96">
