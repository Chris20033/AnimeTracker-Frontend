  ...
  return (
    <section className="grid gap-6 py-8 lg:grid-cols-[minmax(0,0.95fr)_minmax(22rem,0.72fr)] lg:items-stretch lg:py-12">
      <div className="ledger-panel relative overflow-hidden p-6 sm:p-8 lg:p-10">
        ...
        <p className="ledger-kicker">Recupera tu acceso</p>
        <h1 className="ledger-title mt-5 max-w-2xl text-5xl sm:text-6xl">Genera un pase temporal seguro.</h1>
        <p className="ledger-copy mt-5 text-lg">
          Ingresa tu correo y procesaremos la solicitud sin revelar si existe una cuenta asociada.
        </p>
        <div className="mt-8 ledger-inset p-4 text-sm font-semibold leading-6 text-[var(--muted)]">
          El enlace de recuperacion expira y solo puede usarse una vez.
        </div>
      </div>
