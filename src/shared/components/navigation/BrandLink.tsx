...
export function BrandLink() {
  return (
    <NavLink to="/" className="group inline-flex min-w-0 items-center gap-2.5 rounded-2xl outline-none focus:ring-4 focus:ring-[var(--focus)] sm:gap-3" aria-label="AnimeTracker inicio">
      <span className="relative grid size-10 shrink-0 place-items-center overflow-hidden rounded-[0.95rem] border border-[var(--line-strong)] bg-[var(--page-fg)] text-sm font-black text-[var(--page-bg)] shadow-[0_14px_34px_var(--shadow)] transition group-hover:-translate-y-0.5 sm:size-12 sm:rounded-[1.1rem] sm:text-lg">
